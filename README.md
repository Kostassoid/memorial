...
- [Windows x86-64](https://github.com/Kostassoid/memorial/releases/download/v0.2.2/memorial-cli-v0.2.2-x86_64-pc-windows-gnu.zip)
- [macOS Intel](https://github.com/Kostassoid/memorial/releases/download/v0.2.2/memorial-cli-v0.2.2-x86_64-apple-darwin.tar.gz)
- [macOS Apple](https://github.com/Kostassoid/memorial/releases/download/v0.2.2/memorial-cli-v0.2.2-aarch64-apple-darwin.tar.gz)
- [Linux x86-64](https://github.com/Kostassoid/memorial/releases/download/v0.2.2/memorial-cli-v0.2.2-x86_64-unknown-linux-musl.tar.gz)
...
```shell
docker run --rm -it -v $(pwd):/src ghcr.io/kostassoid/memorial:v0.2.2
```
