...
impl <'a> RendererSession<'a> {
    ...
    fn render_footer(&mut self) -> Result<()> {
        self.w(&*format!(
            "\n---\n<sub>Generated by [Posterity](https://github.com/Kostassoid/posterity) v{} at _{}_.</sub>",
...
---
<sub>Generated by [Posterity](https://github.com/Kostassoid/posterity) v0.1.0 at _2023-03-01 12:34:56_.</sub>
        "#.trim();
